    ...
    return (
        <div className="bg-dark vh-100" style={{ marginTop: "69px" }}>
            <Container className="d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="py-2 px-5 m-3 text-light"> Our major project contained an individual presentation after a two week SCRUM sprint. The video below is of that presentation which highlights the design decisions, technologies used and challenges faced in developing this project. We met the MVP and implemented addition functionality. Unfortunately there was a slight coding error during presentation which resulted in the final "admin" page not working correctly. This was fixed minutes after the presentation and updated for the github link below.</div>
