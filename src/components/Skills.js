...
export default function Skills() {
    return (
        <div className="vh-100 d-flex justify-content-center align-items-center skills-bg">
            <div id="skills" style={{ position: "relative", top: "-490px" }}></div>
            <div className="py-5 px-5 text-dark" style={{ backgroundColor: `rgba(${248}, ${249}, ${250}, ${0.8})` }}>
                <div style={{ textTransform: "uppercase", letterSpacing: "30px", fontWeight: "500", lineHeight: "1.2", fontSize: "40px" }}>Skills</div><br />
                <p>Over the last three months I have been completing the Service NSW Software Development Bootcamp for 2020. During this bootcamp I have gained skills in the following areas.</p>
                <hr />
